...
RESOURCE_GROUP="pledgemanager-rg"
LOCATION="canadacentral"
CONTAINERAPPS_ENVIRONMENT="pledgemanager-env"
CONTAINERAPPS_LOG="pledgemanager-log"
CONTAINERAPPS_STORAGE_ACCOUNT="storemanagerstorage"
CONTAINERAPPS_STORAGE_CONTAINER="stateandactors"
CONTAINERAPPS_PUBSUB_NAMESPACE=pledgemanager$RANDOM
