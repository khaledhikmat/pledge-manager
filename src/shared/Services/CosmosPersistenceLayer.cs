            ...
            try
            {
                ...
                List<Campaign> campaigns = new List<Campaign> {
                    new Campaign() {
                        ...
                        ImageUrl = "https://st4.depositphotos.com/14934554/23720/i/600/depositphotos_237205540-stock-photo-contract-sale-new-home-lorem.jpg",
                        Currency = "USD",
                    ...
                    new Campaign() {
                        ...
                        ImageUrl = "https://st4.depositphotos.com/4218696/19780/i/600/depositphotos_197801770-stock-photo-bouqet-of-pink-tulips-and.jpg",
                        Currency = "USD",
                        Start = DateTime.Now.AddDays(-10),
                        Stop = DateTime.Now.AddDays(10),
                        IsActive = true,
                    ...
                    new Campaign() {
                        ...
                        ImageUrl = "https://st2.depositphotos.com/1029541/10004/i/600/depositphotos_100045554-stock-photo-ebook-reader-concept.jpg",
                        Currency = "USD",
                        Start = DateTime.Now.AddDays(-10),
                        Stop = DateTime.Now.AddDays(10),
                        IsActive = true,
                    ...
                    new Campaign() {
                        ...
                        ImageUrl = "https://st2.depositphotos.com/1021974/12187/i/600/depositphotos_121875440-stock-photo-folder-icon-with-text-documents.jpg",
                        Currency = "USD",
                        Start = DateTime.Now.AddDays(-10),
                        Stop = DateTime.Now.AddDays(10),
                        IsActive = true,
